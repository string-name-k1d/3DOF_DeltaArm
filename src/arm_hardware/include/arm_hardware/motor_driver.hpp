#ifndef arm_HARDWARE__MOTOR_DRIVER_HPP_
#define arm_HARDWARE__MOTOR_DRIVER_HPP_
 ...
 * (arm_msgs/srv/MotorParamQuery.srv). request_type selects what to read;
...
#endif  // arm_HARDWARE__MOTOR_DRIVER_HPP_